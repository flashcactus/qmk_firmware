...
[ _base ] = KEYMAP_HHKB(
  ...
  KC_LCTL, KC_LGUI,KC_LALT,        LT(_space,KC_SPACE),                      KC_RALT, KC_RGUI, LT(_menu,KC_MENU),    KC_RCTL),
   /*
...
[ _space ] = KEYMAP_HHKB(
  ...
  KC_TRNS,  KC_LOCK, KC_MUTE, KC_TRNS, KC_TRNS, KC_SPACE,KC_PGDN, KC_MPLY, KC_MPRV, KC_MNXT, KC_TRNS, KC_TRNS, KC_TRNS, \
